...
public class PeopleOcclusion : MonoBehaviour
{
    ...
    public XRCpuImage.Transformation imageTransformation { get; set; }
    ...
    {
        return m_humanBodyManager.subsystem != null && m_humanBodyManager.humanBodyPrefab != null;
    }
    ...
    private void RefreshCameraFeedTexture()
    {
        ...
        m_cameraManager.transform.TryGetComponent(out cameraImage);
    ...
    //XRCpuImage.Transformation imageTransformation = Input.deviceOrientation == DeviceOrientation.LandscapeRight ? CameraImageTransformation.MirrorY : CameraImageTransformation.MirrorX;
